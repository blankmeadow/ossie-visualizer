...
const MESSAGES = {
  zh: {
    ...
    'welcome.body': '导入任意 Ossie JSON，在一套工作台中浏览 Concept、关系、Semantic Model 与 Mapping。纯 Ontology 文档同样支持。',
    'welcome.cta': '打开 Ossie JSON',
    'welcome.featureLocal': '本地解析',
    'welcome.featureCheck': '引用检查',
    'welcome.featureFlow': 'React Flow',
    ...
    'overview.layersEyebrow': '模型分层',
    'overview.layersTitle': '语义分层',
    'overview.layerConcepts': '{count} 个 Concept',
    'overview.layerMaps': '{count} 个 Concept Mapping',
    'overview.layerDatasets': '{count} 个 Dataset',
    'overview.coverageEyebrow': '映射信号',
    'overview.coverageTitle': '映射覆盖',
    'overview.coverageUnit': '{mapped} / {total} concepts',
    'overview.coverageNote': '{count} 个 Concept 没有直接 Mapping；派生 Concept 可能继承父级映射。',
    'overview.coveragePure': '纯 Ontology 文档不要求提供 Mapping。',
    ...
    'relationship.colEntityDescription': '实体描述',
    ...
    'import.title': '打开 Ossie JSON',
    'import.subtitle': '文件只在浏览器内解析，不会上传到服务器。',
    'import.close': '关闭',
    'import.dropzone': '拖入 JSON，或点击选择文件',
    'import.dropzoneHint': '支持纯 Ontology 和包含 Semantic Model/Mapping 的完整 Ossie 文档',
    'import.divider': '或者粘贴',
    'import.textarea': '粘贴 Ossie JSON',
    'import.errorTitle': '无法加载，发现 {count} 个问题',
    'import.errorMore': '还有 {count} 个问题未显示',
    'import.note': 'JSON 在加载前会先做结构和引用检查',
    'import.cancel': '取消',
    'import.submit': '解析并打开',
  ...
  en: {
    ...
    'welcome.title': 'See the ontology, and how the semantics connect',
    'welcome.body': 'Open any Ossie JSON and browse Concepts, relationships, the Semantic Model and Mappings in one workbench. Pure ontology documents work too.',
    'welcome.cta': 'Open Ossie JSON',
    'welcome.featureLocal': 'Parsed locally',
    'welcome.featureCheck': 'Reference checks',
    'welcome.featureFlow': 'React Flow',
    ...
    'overview.statMetrics': 'Metrics',
    'overview.statMappings': 'Concept Mappings',
    'overview.layersEyebrow': 'MODEL LAYERS',
    'overview.layersTitle': 'Semantic layers',
    'overview.layerConcepts': '{count} concepts',
    'overview.layerMaps': '{count} concept maps',
    'overview.layerDatasets': '{count} datasets',
    'overview.coverageEyebrow': 'MAPPING SIGNAL',
    'overview.coverageTitle': 'Mapping coverage',
    'overview.coverageUnit': '{mapped} / {total} concepts',
    'overview.coverageNote': '{count} concepts have no direct mapping; derived concepts may inherit their parent mapping.',
    'overview.coveragePure': 'A pure ontology document is not required to provide mappings.',
    ...
    'concept.colDescription': 'Description',
    ...
    'relationship.colEntityDescription': 'Description',
    ...
    'import.title': 'Open Ossie JSON',
    'import.subtitle': 'The file is parsed in your browser and never uploaded.',
    'import.close': 'Close',
    'import.dropzone': 'Drop a JSON file, or click to choose one',
    'import.dropzoneHint': 'Pure ontologies and full Ossie documents with a Semantic Model / Mapping are both supported',
    'import.divider': 'or paste',
    'import.textarea': 'Paste Ossie JSON',
    'import.errorTitle': 'Cannot load, {count} problems found',
    'import.errorMore': '{count} more problems not shown',
    'import.note': 'JSON is checked for structure and references before it loads',
    'import.cancel': 'Cancel',
    'import.submit': 'Parse and open',
