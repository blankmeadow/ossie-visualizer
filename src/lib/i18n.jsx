...
export const MESSAGES = {
  zh: {
    ...
    'toolbar.miniMap': '缩略图',
    'toolbar.edgeLabels': '边描述',
    'toolbar.depthAll': '全图',
    'toolbar.depthHops': '{count} 阶',
    ...
    'concept.colName': '名称',
    'concept.colVerbalizes': '关系语义',
    'concept.colType': '类型',
    'concept.colRequires': '约束',
    'concept.colRelation': '关系',
    'concept.colEntity': '实体',
    'concept.colConstraint': '约束',
    'concept.colIsPk': '是否主键',
    'concept.yes': '是',
    'concept.no': '否',
    'concept.colType': '类型',
  ...
  en: {
    ...
    'sidebar.collapse': 'Collapse the index',
    'sidebar.expand': 'Show the index',
    ...
    'toolbar.edgeLabels': 'Edge labels',
