...
const MESSAGES = {
  zh: {
    ...
    'import.title': '打开 Ossie 文档',
    'import.subtitle': '文件只在浏览器内解析，不会上传到服务器。',
    'import.close': '关闭',
    'import.dropzone': '拖入 JSON 或 YAML，或点击选择文件',
    'import.dropzoneHint': '支持 .json / .yaml / .yml；纯 Ontology 和包含 Semantic Model/Mapping 的完整文档都可以',
    'import.divider': '或者粘贴',
    'import.textarea': '粘贴 Ossie JSON 或 YAML',
    'import.errorTitle': '无法加载，发现 {count} 个问题',
    'import.errorMore': '还有 {count} 个问题未显示',
    'import.note': '加载前会先做结构和引用检查',
    'import.cancel': '取消',
    'import.submit': '解析并打开',
  ...
  en: {
    ...
    'welcome.cta': 'Open an Ossie document',
    ...
    'import.title': 'Open an Ossie document',
    'import.subtitle': 'The file is parsed in your browser and never uploaded.',
    'import.close': 'Close',
    'import.dropzone': 'Drop a JSON or YAML file, or click to choose one',
    'import.dropzoneHint': '.json / .yaml / .yml -- pure ontologies and full documents with a Semantic Model / Mapping alike',
    ...
    'import.note': 'Checked for structure and references before it loads',
